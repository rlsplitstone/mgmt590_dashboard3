...
## Overview
This is a streamlined NBA Analytics Dashboard with four analytical views (GM, Coach, Scout, League) featuring interactive charts and player/team filters. The dashboard is built with React, Vite, Tailwind CSS, and ShadCN/UI components.
...
- **League View**: Overview of league-wide metrics and trends (NEW)
...
### Multi-Site Hosting Setup (Production & Staging)
The project is now configured with multi-site hosting capabilities to allow testing of new features without affecting the production site:

- **Production**: https://nba-analytics-purdue.web.app
- **Staging**: https://nba-analytics-purdue-staging.web.app

#### Step 1: Configure Firebase targets
```bash
# Ensure you're authenticated with Firebase
firebase login

# Apply the hosting targets
...
### Alternative: Regular Firebase Deployment
If you don't need multi-site hosting, you can use the standard deployment:
